...
abstract contract GasRewardToolUpgradeable is OwnableUpgradeable {
    GasRewardInterface public gas_reward_contract;

    function __GasRewardToolUpgradeable_init() internal {
        __Ownable_init(msg.sender);
    }

    function __GasRewardToolUpgradeable_init_onchained() internal {}
