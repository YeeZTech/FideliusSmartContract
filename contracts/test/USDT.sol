 ...
 */
abstract contract BasicToken is Ownable, IUSDT {
    ...
    function transfer(
        address _to,
        uint256 _value
    ) public virtual onlyPayloadSize(2 * 32) {
...
abstract contract StandardToken is BasicToken {
    ...
    function transferFrom(
        ...
        address _to,
        uint256 _value
    ) public virtual onlyPayloadSize(3 * 32) {
...
interface UpgradedStandardToken is IUSDT {
